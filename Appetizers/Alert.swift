...
struct AlertContext {
    ...
    static let invalidURL      = AlertItem(title: Text("Server Error"), message: Text("Therre was an issue connecting to the server. If this persists, please contact support."), dismissButton: .default(Text("OK")))
